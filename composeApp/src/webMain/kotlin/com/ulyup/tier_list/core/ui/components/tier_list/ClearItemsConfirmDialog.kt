...
fun ClearItemsConfirmDialog(
    ...
    AlertDialog(
        ...
        title = {
            Text(
                text = stringResource(Res.string.detail_clear_title),
        ...
        text = {
            Column(modifier = Modifier.fillMaxWidth()) {
                Text(
                    text = stringResource(Res.string.detail_clear_body),
        ...
        confirmButton = {
            Button(
                ...
                Text(
                    text = stringResource(Res.string.detail_clear_action_confirm),
